...
export class ThanjaihoteloneComponent {
  ...
  constructor(public amountservice:AmountService,public hotelname:HotelnameService, public searchbasedhotelname:SearchbasedhotelnameService ){}
  data:any;
  filteredvalues:any;
  ...
  getamountone(nofrooms,noofdays,amount,typeofhotel){
